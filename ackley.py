...
def fitness(individual):
    #print("Indiv:")
    #print(individual)
    result = -20 * math.exp(-0.2 * math.sqrt(0.5 * (individual[0]**2 + individual[1]**2))) - math.exp(
        0.5 * (math.cos(2 * math.pi * individual[0]) + math.cos(2 * math.pi * individual[1]))) + 20 + math.e
